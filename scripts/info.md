...
```bash
PROTON_HIDE_NVIDIA_GPU=0 PROTON_ENABLE_NVAPI=1 __NV_PRIME_RENDER_OFFLOAD=1 __VK_LAYER_NV_optimus=NVIDIA_only __GLX_VENDOR_LIBRARY_NAME=nvidia VK_ICD_FILENAMES=/usr/share/vulkan/icd.d/nvidia_icd.json WINEDLLOVERRIDES=dxgi=n,b PULSE_LATENCY_MSEC=60 PROTON_ENABLE_NVAPI=1 PROTON_HEAP_DELAY_FREE=1 WINE_FULLSCREEN_FSR=1 WINE_FULLSCREEN_FSR_STRENGTH=5 PROTON_NO_ESYNC=1 gamemoderun %command% -vulkan -height 1080 -width 1920 -fullscreen -high -USEALLAVAILABLECORES -cpuLoadRebalancing -ignorepipelinecache -sgadriver=Vulkan
```

###### WITHOUT ARGS

```bash
PROTON_HIDE_NVIDIA_GPU=0 PROTON_ENABLE_NVAPI=1 __NV_PRIME_RENDER_OFFLOAD=1 __VK_LAYER_NV_optimus=NVIDIA_only __GLX_VENDOR_LIBRARY_NAME=nvidia VK_ICD_FILENAMES=/usr/share/vulkan/icd.d/nvidia_icd.json WINEDLLOVERRIDES=dxgi=n,b PULSE_LATENCY_MSEC=60 PROTON_ENABLE_NVAPI=1 PROTON_HEAP_DELAY_FREE=1 WINE_FULLSCREEN_FSR=1 WINE_FULLSCREEN_FSR_STRENGTH=5 PROTON_NO_ESYNC=1 gamemoderun %command%
```
