...
-- vim.cmd("let g:vsnip_filetypes.javascript = ['javascriptreact']")
-- vim.cmd("let g:vsnip_filetypes.htmldjango = ['html']")
...
-- vim.cmd("let g:vsnip_filetypes.typescript = ['typescriptreact']")
