...
#include "/home/ayush/.cache/wal/colors-wal-dwm.h"
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-p","Run:","-i","-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
